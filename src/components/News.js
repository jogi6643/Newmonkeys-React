...
export default class News extends Component {
  ...
  async updateNews() {
    let url = `https://newsapi.org/v2/top-headlines?country=${
      ...
      this.props.category
    }&apiKey=51a8a4495f574562970cff0bf4a80ed5&page=${
      this.state.page - 1
...
//   };
  ...
  render() {
    ...
    {/* //   <div className="container my-3"> */}
        <h1 className="text-center">News Monkeys -Top {this.props.category}</h1>
        <InfiniteScroll
                ...
                <div className="col-md-4" key={element.url}>
                  <NewsItem
                    ...
                    imageUrl={
                      element.urlToImage
                        ? element.urlToImage
                        : "https://assets.mspimages.in/wp-content/uploads/2021/11/Snapdragon-8-Gen-1.jpg"
                    }
                    newsUrl={element.url}
